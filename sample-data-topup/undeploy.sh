...
# its execution role, and the weekly EventBridge schedule. Does not touch the target mootmaker-api
# environment - no data is deleted.
#
...
echo "Undeploying sample-data-topup environment '${environment}'..."
