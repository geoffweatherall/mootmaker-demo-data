 ...
 * environment. Deliberately duplicated rather than shared with sample-data-generator's identical
 * copy - these are separate Maven projects with no shared-code mechanism (see that copy's own doc
...
class GraphQlClient {
    ...
    /**
     * Builds a client using the OAuth2 client_credentials flow: the acceptance-test app client's
