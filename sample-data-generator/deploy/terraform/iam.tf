...
# The only other AWS permission this function needs: it invokes mootmaker-tools/database-reset as
# the first step of every run (see DatabaseResetInvoker), rather than through GraphQL. Everything
