...
/** Covers {@link DemoData#weekdaysBetween}, the pure date-range logic behind picking which days to top up. */
class DemoDataTest {
    ...
    void includesOnlyMondayThroughFridayAcrossAFullWeek() {
        ...
        final List<LocalDate> weekdays = DemoData.weekdaysBetween(monday, monday.plusDays(7));
    ...
    void endIsExclusive() {
        ...
        final List<LocalDate> weekdays = DemoData.weekdaysBetween(monday, monday.plusDays(1));
    ...
    void returnsNothingForAWeekendOnlyRange() {
        ...
        final List<LocalDate> weekdays = DemoData.weekdaysBetween(saturday, saturday.plusDays(2));
    ...
    void sixWeekWindowContainsExactlyThirtyWeekdays() {
        ...
        final List<LocalDate> weekdays = DemoData.weekdaysBetween(monday, monday.plusDays(42));
    ...
    void returnsNothingWhenStartEqualsEnd() {
        ...
        assertTrue(DemoData.weekdaysBetween(day, day).isEmpty());
    }
}
